            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="card mg-b-30">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <h2 class="tx-20 tx-sm-18 tx-md-24 mg-b-0 tx-rubik tx-dark tx-normal">{{ $user->balance }}
                                kredit</h2>
                        </div>
                        {{-- <div class="d-flex align-items-center tx-gray-500 tx-11"><span class="tx-success mr-2 d-flex align-items-center"><i class="ti-arrow-up tx-8 mr-1 tx-8"></i>+1,551</span>since last day</div> --}}
                    </div>
            ...
            @foreach ($packages as $p)
                ...
                @if (!$p->is_trial)
                    <div class="col">
                        ...
                        <div class="card align-items-center" style="width: 18rem; margin-top:3%">
                            ...
                            <div class="card-body align-items-center">
                                ...
                                @endphp
                                <h5 class="card-title">{{ $customName }}</h5>
                                <p class="card-text "><button type="button" class="btn btn-success">Sifaris et</button></p>
                            </div>
                        </div>
                    </div>
                @endif
